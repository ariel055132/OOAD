...
public class ClassObject extends Shape{
    ...
    public void draw(Graphics2D graphics2D) {
        p2 = new Point(point1.x + width, point1.y);
        ...
        graphics2D.drawLine(point1.x, point1.y + spacing, p2.x, p2.y + spacing);
        graphics2D.drawLine(point1.x, point1.y + spacing * 2, p2.x, p2.y + spacing * 2);
